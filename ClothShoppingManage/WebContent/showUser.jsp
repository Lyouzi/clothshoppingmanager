...
<body style="margin: 0px;padding: 5px;">
	...
	<table id="dg" style="width:100%;height:400px"
		...
		<thead>
			<tr>
			    <th data-options="field:'consumer_id',width:100,align:'center'">ID</th>
				<th data-options="field:'consumer_name',width:100,align:'center'">昵称</th>
				<th data-options="field:'consumer_pwd',width:100,align:'center'">密码</th>
				<th data-options="field:'consumer_img',width:100,align:'center'">头像</th>				
				<th data-options="field:'consumer_tel',width:100,align:'center'">电话</th>
				...
				<!-- <th data-options="field:'delete',width:100,align:'center'">删除客户</th> -->
			</tr>
		</thead>
	</table>
